...
#from huggingface_hub import cached_download, hf_hub_url  # Для работы с Hugging Face API, скачивания моделей   
...
async def main():
    ...
    for pipe in models:
        prompt = "a quick brown fox jumps over the lazy dog"  # Пример запроса для генерации изображения
