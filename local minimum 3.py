...
# Определите координаты и размеры области изображения
image_x_min = 0  # Минимальная координата x для изображения
image_x_max = 10  # Максимальная координата x для изображения
image_y_min = 0  # Минимальная координата y для изображения
image_y_max = 10  # Максимальная координата y для изображения
...
def plot_graph():
    ...
    if image:
        ax.imshow(image, extent=[image_x_min, image_x_max, image_y_min, image_y_max], aspect='auto')
...
x_min_entry.insert(0, "0")  # Значение по умолчанию для x_min
x_max_entry.insert(0, "10")  # Значение по умолчанию для x_max
y_min_entry.insert(0, "0")  # Значение по умолчанию для y_min
y_max_entry.insert(0, "10")  # Значение по умолчанию для y_max
